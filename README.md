...
- создание урока с необязательной привязкой видео;
- загрузка, замена и удаление видео у существующего урока;
...
- проверка существования и типа видео через File Service перед привязкой к уроку;
- частичное обновление и очистка `videoId` через PATCH API;
...
- быстрая проверка существования медиафайла без загрузки его метаданных.
